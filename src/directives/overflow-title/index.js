...
export default app => {
  app.directive('overflow-title', {
    ...
    mounted(el, binding) {
      ...
      // 绑定鼠标事件监听器
      useEventListener(el, 'mouseenter', e => overflowTitleManager.onElementEnter(el, e))
      useEventListener(el, 'mouseleave', () => overflowTitleManager.onElementLeave(el))
      useEventListener(el, 'mousemove', e => overflowTitleManager.onElementMouseMove(el, e))
    },
