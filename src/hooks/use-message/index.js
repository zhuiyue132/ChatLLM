...
const createMessageHandler = (instanceMap, createFn) => {
  return (
    message,
    { type = "warning", duration = 2000, force = false, ...rest } = {},
  ) => {
...
export const showMessage = createMessageHandler(messageInstances, (options) =>
  ElMessage(options),
);

export const showNotification = createMessageHandler(
